...
int main(int argc, char** argv) {
    ...
    cudaMemcpy(d_t, host_t, height * width * channels * sizeof(unsigned char), cudaMemcpyHostToDevice);
    ...
    sobel<<<numBlocks, threadsPerBlock>>>(d_s, d_t, d_height, d_width, d_channels);
