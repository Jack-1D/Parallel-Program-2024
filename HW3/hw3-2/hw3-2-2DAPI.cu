...
int main(int argc, char* argv[]) {
    ...
    cudaMemcpy2D(deviceDist, pitch, hostDist, pad_n * sizeof(int), pad_n * sizeof(int), pad_n, cudaMemcpyHostToDevice);
    ...
    block_FW(deviceDist);
    cudaMemcpy2D(hostDist, pad_n * sizeof(int), deviceDist, pitch, pad_n * sizeof(int), pad_n, cudaMemcpyDeviceToHost);
