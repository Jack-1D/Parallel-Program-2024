...
int main(int argc, char *argv[]) {
    ...
    size_t pitchO, pitchQ, pitchK, pitchV;
    ...
    cudaMemcpy2D(d_O, pitchO, O, N * d * sizeof(float), N * d * sizeof(float), B, cudaMemcpyHostToDevice);
    ...
    cudaMemcpy2D(O, N * d * sizeof(float), d_O, pitchO, N * d * sizeof(float), B, cudaMemcpyDeviceToHost);
